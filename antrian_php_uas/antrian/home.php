...
<body>
    ...
    <div class="containers">
        ...
        <div>
            <a class="button" href="antrian_loket1.php">Ambil Antrian</a>
        </div>
        <hr>
        ...
        <div>
            <a class="button" href="antrian_loket2.php">Ambil Antrian</a>
        </div>
        <hr>
        ...
        <div>
            <a class="button" href="antrian_loket3.php">Ambil Antrian</a>
        </div>
        <hr>
        <div>
            <a class="button" href="../admin/admin-home.php">Admin</a>
        </div>
    </div>
</body>
